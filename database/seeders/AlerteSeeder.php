    ...
    public function run(): void
    {
        ...
        $alertes = [
            ...
            [
                ...
                'message'     => 'Le stock est en dessous du seuil d\'alerte (45 cartons, seuil: 10).',
                'is_lue'      => false,
                'is_resolue'  => false,
            ],
            [
                ...
                'message'     => 'Le stock approche du seuil minimum (80 cartons, seuil: 20).',
                'is_lue'      => false,
                'is_resolue'  => false,
            ],
            ...
            [
                ...
                'message'     => 'Produit complètement épuisé à la Boutique Centrale.',
                'is_lue'      => false,
                'is_resolue'  => false,
            ],
            ...
            [
                ...
                'message'     => 'Produit expire dans moins de 30 jours au Dépôt Principal.',
                'is_lue'      => false,
                'is_resolue'  => false,
            ],
